...
Usage:
    ...
    python scripts/batch_justtcg.py                # default 2000 cards (100 batches)
    python scripts/batch_justtcg.py --limit 500    # fewer cards
    python scripts/batch_justtcg.py --resume       # skip already-fetched cards
"""
