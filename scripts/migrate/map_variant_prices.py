...
Usage:
    ...
    python scripts/migrate/map_variant_prices.py

    # Actually update rows
    python scripts/migrate/map_variant_prices.py --execute

    # Only update one subtype
    python scripts/migrate/map_variant_prices.py --subtype "Reverse Holofoil" --execute
"""
