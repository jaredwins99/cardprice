...
Examples:
    ...
    python scripts/scrapers/scrape_graded_cards.py --grade "PSA 9" --count 100

    # Scrape 50 BGS 9.5 listings (will extract per-corner sub-grades)
    python scripts/scrapers/scrape_graded_cards.py --grade "BGS 9.5" --count 50

    # Scrape PSA 10 with 3 pages max
    python scripts/scrapers/scrape_graded_cards.py --grade "PSA 10" --count 100 --pages 3

    # Scrape all BGS grades (best for corner training data)
    python scripts/scrapers/scrape_graded_cards.py --grade "BGS all" --count 100

    # Check progress
    python scripts/scrapers/scrape_graded_cards.py --stats

    # Skip corner extraction, just download images
    python scripts/scrapers/scrape_graded_cards.py --grade "PSA 10" --count 50 --no-corners
