...
Usage:
    python scripts/eval/eval_stamp_detection.py
    python scripts/eval/eval_stamp_detection.py --dir data/condition_training/stamps/
    python scripts/eval/eval_stamp_detection.py --set ex11
    python scripts/eval/eval_stamp_detection.py --verbose
"""
