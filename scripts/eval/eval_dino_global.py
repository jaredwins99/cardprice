...
Usage:
  python scripts/eval/eval_dino_global.py                    # all unique pages
  python scripts/eval/eval_dino_global.py page_name          # single page
  python scripts/eval/eval_dino_global.py --run-all           # orchestrator mode
"""
