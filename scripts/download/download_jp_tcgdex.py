...
Usage:
  python scripts/download/download_jp_tcgdex.py --list           # List sets with image availability
  python scripts/download/download_jp_tcgdex.py --download       # Download all available JP images
  python scripts/download/download_jp_tcgdex.py --set SV1S       # Download a specific set
  python scripts/download/download_jp_tcgdex.py --download --dry-run  # Preview only
"""
