...
Usage:
    python scripts/download/download_jp_pokellector.py --list              # List JP sets
    python scripts/download/download_jp_pokellector.py --set "Expansion Pack"  # Download one set
    python scripts/download/download_jp_pokellector.py --priority          # WotC-era first
    python scripts/download/download_jp_pokellector.py --all               # Everything
    python scripts/download/download_jp_pokellector.py --thumb             # Download thumbnails instead of full-size
"""
