...
Usage:
    python scripts/download/download_hires_images.py
    python scripts/download/download_hires_images.py --max-concurrent 4 --delay 0.25
    python scripts/download/download_hires_images.py --dry-run
"""
