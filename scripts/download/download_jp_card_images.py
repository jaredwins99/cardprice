...
Usage:
  python scripts/download/download_jp_card_images.py --list          # List available sets
  python scripts/download/download_jp_card_images.py --set "Rocket Gang"  # Download one set
  python scripts/download/download_jp_card_images.py --priority      # Download priority sets
  python scripts/download/download_jp_card_images.py --resume        # Resume interrupted download
  python scripts/download/download_jp_card_images.py --all           # Download everything (multi-day)
  python scripts/download/download_jp_card_images.py --set "Fossil" --dry-run  # Preview only
"""
