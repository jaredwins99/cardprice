...
Usage:
    python scripts/eval_stamp_surface.py
    python scripts/eval_stamp_surface.py --dir data/condition_training/stamps/
    python scripts/eval_stamp_surface.py --threshold 0.90
    python scripts/eval_stamp_surface.py --verbose
"""
