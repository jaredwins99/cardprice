...
Usage:
    python scripts/benchmark_pipeline.py                    # benchmark 3 pages
    python scripts/benchmark_pipeline.py data/inbox/page_20260228_174819.jpg  # specific image
    python scripts/benchmark_pipeline.py --all              # all inbox pages
